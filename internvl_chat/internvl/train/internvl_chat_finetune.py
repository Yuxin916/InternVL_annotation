...
1. Set arguments: 
    ./debug_configs/internvl2_2b_internlm2_1_8b_dynamic_res_2nd_finetune_lora_coco.json
2. Set environment variables:
    TF_CPP_MIN_LOG_LEVEL=3;MASTER_PORT=34229;IS_DEBUG=1;GPUS=1;BATCH_SIZE=256;MASTER_ADDR=127.0.0.1
3. Working directory:
